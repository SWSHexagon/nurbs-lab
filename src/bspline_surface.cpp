...
ClosestPointResult BSplineSurface::closest_point_with_boundary_fallback(
    ...
    double curveTol) const
{
    ...
    std::vector<const BSplineCurve *> candidates;
    ...
    for (const BSplineCurve *c : candidates)
    {
...
ClosestPointResult BSplineSurface::closest_point_global(
    const std::array<double, 3> &P,
    int gridResolution,
    double u0,
    double v0,
